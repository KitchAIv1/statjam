...
### Zone Map (Aligned with Court Image)

**Note:** Basket is at TOP, half-court line at BOTTOM (matching the PNG asset)
...
Based on the half-court image asset (`halfcourt-71072f78.png`):

- **X-axis:** 0-100 (left to right of half-court)
- **Y-axis:** 0-100 (baseline/basket at TOP → half-court line at BOTTOM)
- **Origin (0,0):** Top-left corner (left side of baseline, near basket)
...
**Location:** `/assets/halfcourt-71072f78-c865-4379-bead-1e8222671001.png`

The SVG zone overlays will be placed on top of this PNG background image.
