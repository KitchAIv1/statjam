/**
 * RetroactiveAwardModal - Add Awards to Completed Game
 * 
...
import { X, Trophy, Sparkles, CheckCircle, Calendar } from 'lucide-react';
...
export function RetroactiveAwardModal({
  ...
  const handleComplete = async () => {
    ...
    try {
      ...
      console.error('Failed to add awards:', error);
      alert('Failed to add awards. Please try again.');
    } finally {
      setSaving(false);
    }
  };
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-4xl mx-4 max-h-[90vh] flex flex-col">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div>
            <h2 className="text-2xl font-bold text-gray-900">Add Awards to Completed Game</h2>
