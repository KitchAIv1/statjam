...
export function ImpactFormulaExplainer({ className = '' }: ImpactFormulaExplainerProps) {
  return (
    <div className={`bg-gradient-to-br from-purple-50 to-indigo-50 p-5 rounded-lg border border-purple-200 ${className}`}>
      ...
      <div className="bg-white p-4 rounded-lg border border-purple-100 mb-4">
        <p className="text-sm font-mono text-purple-800 text-center leading-relaxed">
      ...
      <div className="space-y-3 text-sm">
        ...
        <div className="grid grid-cols-2 gap-3 mt-3">
          <div className="bg-emerald-50 p-3 rounded-lg">
            <p className="text-emerald-800 font-medium text-xs uppercase mb-1">High Value (2×)</p>
          ...
          <div className="bg-blue-50 p-3 rounded-lg">
            <p className="text-blue-800 font-medium text-xs uppercase mb-1">Medium Value (1.2-1.5×)</p>
