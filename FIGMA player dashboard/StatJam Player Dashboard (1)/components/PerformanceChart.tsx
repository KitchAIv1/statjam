...
import { Calendar, TrendingUp, Target, Filter } from 'lucide-react';
    ...
    switch (viewMode) {
      ...
      case 'tournaments':
        return tournamentData.map(tournament => ({
          ...
          points: tournament.avgPoints,
          assists: tournament.avgAssists,
          rebounds: tournament.avgRebounds,
          fieldGoal: tournament.avgFieldGoal,
          threePoint: tournament.avgThreePoint,
          freeThrow: tournament.avgFreeThrow,
        }));
      default:
